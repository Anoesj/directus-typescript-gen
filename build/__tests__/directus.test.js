...
describe(`Directus SDK`, () => {
    test(`Connect and fetch`, async () => {
        ...
        expect(await client.items(`author`).readOne(`john.doe@example.com`, {
        ...
        await expect(() => client.items(`author`).readOne(`john.doe@example.com`, {
            fields: [`first_name`, `last_name`],
        })).rejects.toBeTruthy();
        await client
            .items(`author`)
        ...
        expect(await client.items(`article_author`).readMany({
            filter: {
                author_email: `john.doe@example.com`,
            },
            fields: [`article_id`],
...
//# sourceMappingURL=directus.test.js.map